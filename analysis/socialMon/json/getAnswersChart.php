<?php
	...
	switch ($frequency) {
		case "daily":
			$prevDate = date('Y-m-d H:m:s', strtotime($today . ' -'.$_POST['numAnt'].' day'));
			break;
		case "weekly":
			$prevDate = date('Y-m-d H:m:s', strtotime($today . ' -'.$_POST['numAnt'].' week'));
			break;
		case "2weeks":
			$prevDate = date('Y-m-d H:m:s', strtotime($today . ' -'.$_POST['numAnt'].' week'));
			break;
		case "3weeks":
			...
			break;
		case "monthly":
			$prevDate = date('Y-m-d H:m:s', strtotime($today . ' -'.$_POST['numAnt'].' month'));
			break;
		case "2months":
			$prevDate = date('Y-m-d H:m:s', strtotime($today . ' -'.$_POST['numAnt'].' month'));
			break;
		...
		case "6months":
			...
			break;
		case "yearly":
			$prevDate = date('Y-m-d H:m:s', strtotime($today . ' -'.$_POST['numAnt'].' year'));
			break;
		default:
			# code...
			break;
