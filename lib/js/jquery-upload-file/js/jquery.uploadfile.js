...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            uploadButtonClass: "btn btn-sm btn-primary",
            dragDropStr: "<span style='margin-bottom:20px;'> &nbsp; Arrastra y suelta archivos</span>",
        ...
        var uploadLabel = $('<div style="margin-bottom:10px;">' + s.uploadStr + '</div>');
