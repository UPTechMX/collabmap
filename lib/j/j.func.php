...
function delDirContent($geoserverWorkSpaceName){
	try {

		// echo "AAAA";
		$myfile = fopen("/var/www/test/testfile.txt", "w");
		// echo "$geoserverWorkSpaceName";
		exec("sh ".raiz()."admin/administration/targets/structure/json/rm.sh $geoserverWorkSpaceName"  );
