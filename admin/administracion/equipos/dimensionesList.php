<?php  
	...
	// print2($_POST);
	$dimensiones = $db->query("SELECT * FROM Dimensiones WHERE areasId = $_POST[areasId]")->fetchAll(PDO::FETCH_ASSOC);
...
<script type="text/javascript">
	$(document).ready(function() {
		$('.edtDim').click(function(event) {
			...
			popUp('admin/administracion/equipos/dimensionesAdd.php',{dimensionId:dimensionId,areasId:<?php echo $_POST['areasId']; ?>},function(e){},{});
		});
