<?php  
	...
	if($_POST['bloqueId'] != ''){
		$datM = $db-> query("SELECT * FROM BloquesExt WHERE id = $_POST[bloqueId]")->fetch(PDO::FETCH_ASSOC);
	}
	// print2($datM);
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#env').click(function(event) {
			...
			if(allOk){
				var rj = jsonF('admin/checklistExt/json/json.php',{datos:dat,acc:acc,opt:5});
				// console.log(rj);
				var r = $.parseJSON(rj);
				// console.log(r);
				if(r.ok == 1){
