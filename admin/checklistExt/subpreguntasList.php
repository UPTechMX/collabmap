...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#subpreguntasList_<?php echo $_POST['pregId']; ?> .edtSubpreg').click(function(event) {
			...
			popUp('admin/checklistExt/subpreguntasAdd.php',{pregId:pregId,subpregId:subpregId},function(e){},{});
		});
		...
		$('#subpreguntasList_<?php echo $_POST['pregId']; ?> .delSubpreg').click(function(event) {
			...
			conf('¿Está seguro que desea elilminar la pregunta?',{subpregId:subpregId,pregId:pregId},function(e){
				// console.log(pregId,areaId);
				var rj = jsonF('admin/checklistExt/json/json.php',{datos:{id:e.subpregId,elim:1},acc:2,opt:7});
				var r = $.parseJSON(rj);
				if(r.ok == 1){
					$('#subpreguntasList_<?php echo $_POST["pregId"]; ?>').load(rz+'admin/checklistExt/subpreguntasList.php',
