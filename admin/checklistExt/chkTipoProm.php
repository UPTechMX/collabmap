<?php
	...
	// print2($_POST);
	checaAcceso(50);
	$chk = $db -> query("SELECT * FROM ChecklistExt WHERE id = $_POST[chkId]")->fetchAll(PDO::FETCH_ASSOC)[0];
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#env').click(function(event) {
			...
			var rj = jsonF('admin/checklistExt/json/json.php',{datos:{id:chkId,tipoProm:tipoProm,tipoAnalisis:tipoAnalisis},acc:2,opt:11});
			console.log(rj);
			var r = $.parseJSON(rj);
			// console.log(r);
			if(r.ok == 1){
