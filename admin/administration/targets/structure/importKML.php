	...
	$(document).ready(function() {
		...
		subArch(
			...
			function(e){
				...
				var rj = jsonF('admin/administration/targets/structure/json/getAttributes.php',{file:file});
				console.log(rj);
				var r = $.parseJSON(rj);
		...
		$('#envKML').click(function(event) {
			...
			if(file != '' && idAttr != '' && KMLName != ''){
				var elemId = '<?= $_POST['elemId']; ?>';
				var type = '<?= $_POST['type']; ?>';
				var rj = jsonF('admin/administration/targets/structure/json/uplKML.php',{file:file,idAttr:idAttr,elemId:elemId,type:type,KMLName:KMLName});
				// console.log(rj);
				var r = $.parseJSON(rj);
				// console.log(r);
				if(r.ok == 1){
...
<div class="modal-footer">
	<div style="text-align: right;">
		...
		<span id="envKML" class="btn btn-sm btn-shop" style="display: none;"><?php echo TR('send'); ?></span>
	</div>
</div>