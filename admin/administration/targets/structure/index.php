...
<script type="text/javascript">
	$(document).ready(function() {
		$('#addEquipo').click(function(event) {
			popUp('admin/administracion/targets/structure/equiposAdd.php',{},function(){},{});
		});
		$('#areasId').change(function(event) {
			var areasId = $(this).val();
			if(areasId != ''){
				$('#equipos').load(rz+'admin/administracion/targets/structure/dimensiones.php',{areasId:areasId});
			}
		});
