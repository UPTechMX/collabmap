...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#env').click(function(event) {
			...
			?>
			consultationId = <?php echo $datC['consultationsId']; ?>;


			if(allOk){
				var rj = jsonF('admin/administration/consultations/json/json.php',{datos:dat,acc:acc,opt:2});
				// console.log(rj);
				var r = $.parseJSON(rj);
				// console.log(r);
				if(r.ok == 1){
					$('#popUp').modal('toggle');
					$('#surveysList').load(rz+'admin/administration/consultations/surveysList.php',{consultationId:consultationId});
				}
			}
