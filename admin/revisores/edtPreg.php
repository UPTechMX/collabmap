	...
	$(document).ready(function() {
		...
		$('#env').click(function(event) {
			...
			if(allOk){
				...
				// console.log(datos);
				var rj = jsonF('admin/revisores/json/envResp.php',{datos:datos,hash:hash,pId:pIdAct});
				console.log(rj);
				var r = $.parseJSON(rj);
					...
					function(){
						if(r.ok == 1){
							<?php if ($_POST['noRevisor'] == 1) { ?>
								...
								$('#visita').load(rz+'admin/proyectos/revision.php',{vId:<?php echo $_POST['vId']; ?>,hash:hash});
							<?php }elseif($_POST['noRevisor'] == 2){ ?>
								// console.log('ssd');
								location.reload();
							<?php }else{ ?>
