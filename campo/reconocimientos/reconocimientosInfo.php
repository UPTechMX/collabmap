<?php  
	...
	if($_POST['eleId'] != ''){
		$datC = $db-> query("SELECT r.*,u.nombre as uNom 
	...
	$ubicaciones = $db->query("SELECT id as val, nombre as nom, 'clase' as class FROM Ubicaciones")->fetchAll(PDO::FETCH_ASSOC);
...
<div>
	<div class="nuevo barra manita verArea">
		Ubicaciones <span style="float:right;"><i class="glyphicon glyphicon-menu-right manita"></i></span>
	</div>
	<div class="area" style="display:none;" id="ubicaciones">
		<div style="margin:10px 0px;">
			<div class="row">
				<div class="col-5">
					<select class="form-control" id="ubicacionesId">
				...
				<div class="col-7">
					<span  class="btn btn-sm btn-shop" id="verUbic">Ver ubicacion</span>
					<span  class="btn btn-sm btn-shop" id="ubicAdd">Nueva ubicacion</span>
				</div>
			</div>
			<div style="text-align: left;margin: 10px 0px;">
				<span class="btn btn-sm btn-shop" id="addRecUbic">Agregar ubicación</span>
			</div>
		</div>
