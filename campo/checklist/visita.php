<?php  
	...
	$sql = "SELECT v.*, CONCAT(IFNULL(c.nombre,''),' ',IFNULL(c.aPat,''),' ',IFNULL(c.aMat,'')) as nombre, v.fecha, v.resumen as vRes, 
				c.calle, c.numeroExt, c.numeroInt, e.nombre as eNom, m.nombre as mNom, c.colonia, c.codigoPostal,c.instalacionRealizada
				FROM Visitas v
